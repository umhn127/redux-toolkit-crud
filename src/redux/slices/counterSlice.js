...
const counterSlice = createSlice({
  ...
  //state in nasıl depişeceğine karar veren fonksiyonları tanımlarız
  reducers: {
    increase: (state) => {
      state.count++;
    },
...
//slice ın oluşturduğu reducer fonksiyonunu store tanıtmak için export edelim
export default counterSlice.reducer;

// slice ın oluşturduğu aksiyon fonksiyonlarını bileşenlerde kullanmak için export edelim
